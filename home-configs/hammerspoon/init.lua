...
hs.loadSpoon("KeyLightNeo")
hs.loadSpoon("MeetSetup")
...
-- Absolute paths to nix built helpers, generated by home-manager
local nixPaths = require("nix-paths")
spoon.KeyLightNeo.helperPath = nixPaths.elgatoUsb

spoon.MeetSetup.audioSwitcher = spoon.AudioSwitcher
spoon.MeetSetup.keyLight = spoon.KeyLightNeo
spoon.MeetSetup:bindHotkeys({revert = {{"cmd", "alt"}, "x"}})
...
-- Meet links get audio and lighting prepared before Chrome opens them
spoon.URLDispatcher.url_patterns = {
  {"https?://meet%.google%.com", function(url) spoon.MeetSetup.open(url) end},
}
